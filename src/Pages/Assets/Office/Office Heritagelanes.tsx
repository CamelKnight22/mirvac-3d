...
import OfficeAssetNavbar from "../../../Components/Navbar/Office-Navbar"
import { Building3 } from "../../../gltfjsx/Building 3"

const OfficeHeritagelanes = () => {
    return(
      ...
      <Canvas shadows dpr={[1, 2]} camera={{ fov: 50, position: [19, 19, 10] }}>
       ...
       <Environment preset="city" />
         <spotLight position={[-10, 10, -10]} angle={Math.PI / 1} intensity={2} />
             ...
             <Building3 position={[0,0,0]} rotation={[0, Math.PI/2, 0]} scale={2}/>
...
export default OfficeHeritagelanes